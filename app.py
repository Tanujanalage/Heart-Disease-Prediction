...
st.markdown("Provide the followig details")
...
if st.button("Predict"):
    ...
    num_cols = scaler.feature_names_in_ if hasattr(scaler, "feature_names_in_") else ["Age", "RestingBP", "Cholesterol", "MaxHR", "Oldpeak"]
